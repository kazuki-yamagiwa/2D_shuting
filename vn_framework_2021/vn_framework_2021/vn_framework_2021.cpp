// vn_framework_2021.cpp : アプリケーションのエントリ ポイントを定義します。
//

#include "framework.h"
#include "framework/vn_environment.h"
#include "vn_framework_2021.h"
                     ...
                     _In_ int       nCmdShow)
{
    ...
    LoadStringW(hInstance, IDC_VNFRAMEWORK2021, szWindowClass, MAX_LOADSTRING);
    ...
    HACCEL hAccelTable = LoadAccelerators(hInstance, MAKEINTRESOURCE(IDC_VNFRAMEWORK2021));
    ...
    //メインフレームの初期化
    vnMainFrame::initialize(hWnd, hInst);
...
ATOM MyRegisterClass(HINSTANCE hInstance)
{
    ...
    wcex.hIcon          = LoadIcon(hInstance, MAKEINTRESOURCE(IDI_VNFRAMEWORK2021));
    wcex.hCursor        = LoadCursor(nullptr, IDC_ARROW);
    wcex.hbrBackground  = (HBRUSH)(COLOR_WINDOW+1);
    wcex.lpszMenuName   = NULL;// MAKEINTRESOURCEW(IDC_VNFRAMEWORK2021);
